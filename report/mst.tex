...
livremente para fins não comerciais. %A figura \ref{fig:02_DONI22009_delaunay}
%mostra a triangulação de Delaunay obtida pela biblioteca para a entrada
%DONI22009 (figura \ref{fig:02_DONI22009_euclidean}).
